        ...
        <form onSubmit={handleSubmit} className="flex max-w-4xl flex-col gap-6 bg-slate-400 p-10 rounded-md">
          <div className="flex gap-10">
            <div className="flex w-full flex-col gap-6">
              ...
              <div>
                <div className="mb-2 flex items-center">
                  <Label className="text-lg font-semibold" htmlFor="lastName" value="Last Name" />
              ...
              <div>
                <div className="mb-2 flex items-center">
                  <Label className="text-lg font-semibold" htmlFor="email" value="Your email" />
              ...
              <div>
                <div className="mb-2 flex items-center">
                  <Label className="text-lg font-semibold" htmlFor="dateOfBirth" value="Date of Birth" />
            ...
            <div className="flex w-full flex-col gap-6">
              <div>
                <div className="mb-2 flex items-center">
                  <Label className="text-lg font-semibold" htmlFor="address" value="Address" />
              ...
              <div>
                <div className="mb-2 flex items-center">
                  <Label className="text-lg font-semibold" htmlFor="phoneN" value="Phone number" />
              ...
              <div>
                <div className="mb-2 flex items-center">
                  <Label className="text-lg font-semibold" htmlFor="password" value="Password" />
              ...
              <div>
                <div className="mb-2 flex items-center">
                  <Label className="text-lg font-semibold" htmlFor="confPass" value="Confirm Password" />
